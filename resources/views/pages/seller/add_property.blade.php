...
@section('content')
    ...
    <section class="container mx-auto py-10">
        ...
        <form action="{{ route('seller_store_property') }}" method="post" enctype="multipart/form-data"
            ...
            <div>
                ...
                <div class="relative grid grid-cols-3 gap-2" id="photoContainer">
                    ...
                    <div class="relative">
                        ...
                        <input type="file" id="photo1" name="photo[]" required onchange="previewImageProperty(this)"
            ...
            <button type="submit" class="bg-button hover:bg-yellow-500 px-3 py-2">Submit</button>
        </form>
    </section>
@endsection
