                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b ">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button onclick="viewLicense(this)" data-url="{{  $seller->license }}" class="underline text-blue-500">
                                    view
                                </button>
                                |
                                <a href="{{ route('admin_license_download',['id' => $seller->id]) }}"  class="underline text-blue-500">download</a>
                            </td>
