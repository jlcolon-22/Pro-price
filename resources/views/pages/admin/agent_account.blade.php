...
@section('content')
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b ">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button onclick="viewLicense(this)" data-url="{{  $agent->license }}" class="underline text-blue-500">
                                    view
                                </button>
                                |
                                <a href="{{ route('admin_agent_license_download',['id' => $agent->id]) }}"  class="underline text-blue-500">download</a>
                            </td>
    ...
    <div id="modal" class="hidden top-0 left-0 overflow-y-auto  w-full min-h-[100svh] bg-black/40 p-10">
            <div class="relative oveflow-y-auto max-h-[500px]">
                <img src="{{ asset('icons/x.svg') }}" onclick="closeModal()" class="absolute top-4 right-4 bg-gray-100 rounded-full" alt="">
                <img id="viewImageID" src="{{ asset('assets/r-architecture-JvQ0Q5IkeMM-unsplash.jpg') }}" class="w-[80%] mx-auto"  alt="">
